...
// 송신할 메시지를 입력받아 상대방에게 송신하고, 상대방이 보낸 메시지를 받아 화면에 출력한다. 
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (true) {
				...
				//String recieveMsg = new String(bMsg, 0, inpacket.getLength(), "utf-8"); // 방법1
				String recieveMsg = new String(inpacket.getData(), 0, inpacket.getLength(), "utf-8"); // 방법2
				System.out.println("서버의 응답 메시지 : " + recieveMsg);
				System.out.println();
			}// while문 끝
