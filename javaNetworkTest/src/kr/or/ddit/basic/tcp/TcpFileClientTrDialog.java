...
public class TcpFileClientTrDialog {
	public static void main(String[] args) {
		new TcpFileClientTrDialog().clientStart();
	}
	...
	private File showDialog(String openType) {
		...
		FileNameExtensionFilter txt = new FileNameExtensionFilter("txt파일", "txt");
		...
		// chooser.setAcceptAllFileFilterUsed(false); // false - 모든파일 설정 제외(맨처음 지정 파일,
		// true - 모든파일 설정 포함.
		// chooser.setAcceptAllFileFilterUsed(true); // 기본값

		// Dialog창이 나타날 때 기본적으로 보여줄 경로
