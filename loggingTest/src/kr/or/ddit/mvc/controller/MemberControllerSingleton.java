...
import kr.or.ddit.mvc.service.MemberServiceImplSingleton;
import kr.or.ddit.mvc.vo.MemberVO;

public class MemberControllerSingleton {
	private Scanner scan;
	private IMemberService service; // Service객체 변수 선언

	// 생성자
	public MemberControllerSingleton() {
		scan = new Scanner(System.in);
		//service = new MemberServiceImpl(); // Service객체 생성
		service = MemberServiceImplSingleton.getInstance(); // Service singleton 객체 생성
	}

	public static void main(String[] args) {
		new MemberControllerSingleton().startMember();
	}
