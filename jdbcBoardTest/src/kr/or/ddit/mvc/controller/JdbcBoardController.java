...
import kr.or.ddit.mvc.service.IJdbcBoardService;
import kr.or.ddit.mvc.service.JdbcBoardServiceImpl;
	...
	public int displayMenu(String searchTitle) {
		...
		if(boardList == null || boardList.size() == 0) {
			...
			for (BoardVO boardVO : boardList) {
				System.out.printf(" %d\t%s\t\t%s\t\t%d\n", boardVO.getBoard_no(), boardVO.getBoard_title(), boardVO.getBoard_writer(), boardVO.getBoard_cnt());
