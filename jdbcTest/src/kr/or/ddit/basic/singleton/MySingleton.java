 ...
 *    (이 메서드의 이름은 보통 getInstance로 한다. 자신 class의 인스턴스를 생성하므로 변수타입은 클래스명과 같게 해준다.)  
 * 
 */
public class MySingleton {
	...
	// 2번 - 기본생성자는 public으로 만들어지므로 private으로 만들어주기
	private MySingleton() {
	...
	public void displayTest() {
		System.out.println("이 메시지는 싱클톤 클래스의 메서드에서 보낸 메시지입니다...");
	}
}
