...
// Request객체를 이용하여 요청할 대 가져온 데이터 처리하기
...
public class RequestTest01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setCharacterEncoding("utf-8"); // 안하면 한글 깨짐!! get에서 한글 깨지면 server.xml 확인
		
		// 전달되는 데이터 받기
		// request.getParameter("파라미터명") ==> 해당 파라미터에 설정된 '값'을 가져온다.(태그의 name속성이 파라미터명이 된다.)
		...
		out.println("<html><body><meta charset='utf-8'><title>Request객체 연습</title></head>");
		out.println("<body>");
