...
public class MapTest {
	 ...
	 */
		...
		System.out.println("map ==> " + map); // 입력한 순서대로 출력안됨. set과 비슷하게 임의 순서로 출력됨
		
		// 자료 수정 ==> 데이터를 추가할 때 key값이 같으면 value값이 나중에 입력한 값으로 덮어쓴다.
		map.put("addr", "서울");
...
//		System.out.println("sTemp : " + sTemp);
		...
		// 자료 읽기(=꺼내오기) ==> get(key값) : key값과 짝이 되는 value값이 반환된다.
