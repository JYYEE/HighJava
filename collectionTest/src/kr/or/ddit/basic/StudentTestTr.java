...
public class StudentTestTr {
	...
	public static void main(String[] args) {
		StudentTestTr testTr = new StudentTestTr();
...
class Student implements Comparable<Student> {
	...
	public int compareTo(Student std) {
		return Integer.compare(this.getNum(), std.getNum());// 오름차순 그대로, 내림차순 *-1
	}
...
// 총점의 역순으로 정렬(내림차순 정렬)하는데 총점이 같으면 이름의 오름차순으로 정렬이 되는 외부 정렬 기준 클래스
