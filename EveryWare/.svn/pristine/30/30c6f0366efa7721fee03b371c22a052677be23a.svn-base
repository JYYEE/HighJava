...
/**
 * Servlet implementation class InsertFree
 */
@WebServlet("/InsertFree.do")
public class InsertFree extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("자유게시판 아이디 "+evo.getEmp_id());
		...
		int cnt = service.insertFree(vo);
	  System.out.println(cnt);
	  response.sendRedirect(request.getContextPath() +"/freeposts.do");
		}
