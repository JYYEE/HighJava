...
<body>
    ...
    <a href="<%=request.getContextPath()%>/Posts/post/FilePost.jsp" style="display: inline-block;  color: white;  background: #04AA6D; padding: 10px 24px; border: none; border-radius: 4px; margin: 3px;">양식함</a>
				...
				<table class="table table-bordered">
					<tr>
                     ...
                     <tr>
						...
						<td colspan="4"><textarea class="board-memo" name="content"id="summernote" style="width: 100%"></textarea>
