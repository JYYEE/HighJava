...
<div class="page-header">
	...
	<span><input type="button" id="vacMng" class="vac-btn" value="휴가 관리 대장" onclick="location.href='<%=request.getContextPath()%>/vac/vacationManager.jsp'"></span>
		...
		<tbody>
			...
			<tr>
				<th><label class="vac-menu vac-textarea" for="vac-approver"><span id="vac-app-lab">휴가 승인자</span></label></th>
				<td><input type="text" class="vac-ins-rea" name="vacApprove" value="관리자" disabled></td>
			</tr>
		</tbody>
		<tfoot>
			<tr>
