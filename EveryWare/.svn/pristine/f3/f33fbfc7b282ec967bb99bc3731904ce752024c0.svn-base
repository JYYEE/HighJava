...
/**
 * Servlet implementation class freeposts
 */
@WebServlet("/freeposts.do")
public class freeposts extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/Posts/post/FreePostsList.jsp").forward(request, response);
